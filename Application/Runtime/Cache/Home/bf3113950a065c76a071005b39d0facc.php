	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="/Home/Index/getSn" method="post">
					<ul>
						<li>
							<label for="">验证码：</label>
							<input type="text" class="txt" name="username" />
                                                        <input type="button"  value="重新发送验证码" id="again_send">
						</li>
                                             <li>
							<label for="">&nbsp;</label>
    ...
    $(function(){
       ...
       $('#again_send').click(function(){
           ...
           $(this).attr('disabled','disabled');
            $.ajax({
            url:"/Home/Index/ajaxReSendCode/username/<?php echo $username?>",   
