	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
					...
					<ul>
						...
						<li>
							...
							<input type="password" class="txt" name="password" />
                                                        <a href="/Home/Index/forgetpassword" target="_blank">忘记密码?</a>
						</li>
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="checkcode" />
							<img src="/Home/Index/Verify" alt="" onclick="this.src='/Home/Index/Verify'"/>
			...
			<div class="guide fl">
				...
				<a href="/Home/Index/regist" class="reg_btn">免费注册 >></a>
			</div>
