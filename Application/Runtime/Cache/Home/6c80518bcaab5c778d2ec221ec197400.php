	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="/index.php/Home/Index/change_password/email_chk_str/c0546301ff036a7a3e5e142cc33fc58f" method="post">
                                    <input type="hidden" name='user' value='<?php echo $user?>'> 
                                    <input type="hidden" name='email_chk_str' value='<?php echo $email_chk_str?>'> 
    
					<ul>
                                            <li style="height:32px;">
						<label for="">用户名：</label>
                                                <span style="font-size:18px;font-weight:bold;"><?php echo '&nbsp;'.$user;?></span>
						</li>
						<li>
							<label for="">新密码：</label>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="submit" value="" class="forget_btn" />
						</li>
					</ul>
				</form>
